...
# usi zatqo qosqanim 39-45 qatarlaar

app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],          # Access-Control-Allow-Origin: *
    allow_credentials=False,     # agar cookie/auth ishlatsangiz, false qilmang deb bo‘lmaydi
    allow_methods=["*"],         # GET/POST/PUT/DELETE/OPTIONS
    allow_headers=["*"],         # Content-Type, Authorization va h.k.
)
